...
<html lang="en">
    ...
    <div class="row">
                ...
                <!--------------------------------Fin obtener empresas----------------->
                        ...
                        <div class="form-group">
                            <div class="row" style="width:200px">
                                <div class="col">
                                    <label for="myCodigoR">Documento (Entradas/Ingresos)</label>
                                    <input type="number" id="myCodigoR" name="myCodigoR" class="form-control" requiredplaceholder="Ingrese código">
                                </div>
                            </div>
                            <div class="row" style="width:200px">
                                <div class="col">
                                    <label for="myCodigoInR">Documento (Salidas/Egresos)</label>
                                    <input type="number" id="myCodigoInR" name="myCodigoInR" class="form-control" requiredplaceholder="Ingrese código">
                                </div>
                            </div>
                            <div class="row" style="width:200px">
                                <div class="col">
                    ...
                    <input type="button" id="btnVentas" onclick="venta($('#clienteR').val(),$('#productosR').val(),$('#myCodigoR').val(),$('#myCodigoInR').val(),$('#fechaR').val(),$('#precioRA').val());" value="Agregar entrada" class="btn btn-primary" />
                    <a class="btn btn-success" href="RegistroIngresos.php" role="button">Registro entradas</a>
                    ...
                    <td>
                        ...
                        <form method="post" name="formProductos">
                            ...
                            <input type="hidden" name="fecha_registroR" value="<?php echo $producto['fecha'];?>">
                                ...
                                <div class="col">
                                    <input type="number" id="cantidadR<?php echo $producto['id'];?>" name="cantidadR" style="width:100%" value="1" min="1">
                                </div>
                                <div class="col">
        ...
        //OPERACIONES AUTOMATICAS AL AGREGAR PRODUCTOS
                ...
                function venta(cliente,producto,codigo,codigoIn,fecha,precio) {

                    console.log(cliente,producto,codigo,fecha,precio);
                    datos=jsonPrueba;

                    if (confirm("Agregar salida")) {
                        var parametros = {"Informacion":datos, "clienteR":cliente, "codigoR":codigo,"codigoInR":codigoIn, "fechaR":fecha, "precioRA":precio };
